        ...
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm font-medium uppercase mt-6 mb-2">Scan to Pay</p>
                    <div className="border border-gray-300 bg-white rounded-md p-3 flex flex-col items-center">
                        <img src="/qr.jpg" alt="QR Code" className="w-48 h-48 object-contain mb-2" />
                        <p className="text-sm text-gray-600 text-center">Scan the QR code using any UPI app to complete your payment.</p>
                    </div>
                </div>
